...
class Resep extends Admin_Controller {
	...
	public function __construct()
  {
	...
	{
		//load data
		$data['resep'] = $this->Model_resep->select_all();
		// error handling
		...
		// load page
		$data['content'] = $this->load->view('admin/resep', $data, TRUE);

		//load template
		$data['title'] = "Resep";
		$data['desc'] = "Kelola Resep";
		$data['breadcrumb'] = array('Dashboard', 'Resep');

		$this->load->view('admin/template', $data);
	}

	// public function newresep()
	// {
