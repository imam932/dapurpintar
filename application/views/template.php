...
<link rel="stylesheet" href="<?= base_url() ?>assets/vendor/usertemp/css/theme-elements.css" />
<!DOCTYPE HTML>
<head>
...
<link rel="apple-touch-icon" sizes="196x196" href="<?= base_url() ?>assets/vendor/usertemp/images/splash/apple-touch-icon-196x196.png">
<link rel="apple-touch-icon" sizes="180x180" href="<?= base_url() ?>assets/vendor/usertemp/images/splash/apple-touch-icon-180x180.png">
<link rel="apple-touch-icon" sizes="152x152" href="<?= base_url() ?>assets/vendor/usertemp/images/splash/apple-touch-icon-152x152.png">
<link rel="apple-touch-icon" sizes="144x144" href="<?= base_url() ?>assets/vendor/usertemp/images/splash/apple-touch-icon-144x144.png">
<link rel="apple-touch-icon" sizes="120x120" href="<?= base_url() ?>assets/vendor/usertemp/images/splash/apple-touch-icon-120x120.png">
<link rel="apple-touch-icon" sizes="114x114" href="<?= base_url() ?>assets/vendor/usertemp/images/splash/apple-touch-icon-114x114.png">
<link rel="apple-touch-icon" sizes="76x76" href="<?= base_url() ?>assets/vendor/usertemp/images/splash/apple-touch-icon-76x76.png">
<link rel="apple-touch-icon" sizes="72x72" href="<?= base_url() ?>assets/vendor/usertemp/images/splash/apple-touch-icon-72x72.png">
<link rel="apple-touch-icon" sizes="60x60" href="<?= base_url() ?>assets/vendor/usertemp/images/splash/apple-touch-icon-60x60.png">
<link rel="apple-touch-icon" sizes="57x57" href="<?= base_url() ?>assets/vendor/usertemp/images/splash/apple-touch-icon-57x57.png">  
<link rel="icon" type="image/png" href="<?= base_url() ?>assets/vendor/usertemp/images/splash/favicon-96x96.png" sizes="96x96">
<link rel="icon" type="image/png" href="<?= base_url() ?>assets/vendor/usertemp/images/splash/favicon-32x32.png" sizes="32x32">
<link rel="icon" type="image/png" href="<?= base_url() ?>assets/vendor/usertemp/images/splash/favicon-16x16.png" sizes="16x16">
<link rel="shortcut icon" href="<?= base_url() ?>assets/vendor/usertemp/images/splash/favicon.ico" type="image/x-icon" /> 
    
<title>Dapur Pintar</title>

<link href="<?= base_url() ?>assets/vendor/usertemp/styles/style.css"           rel="stylesheet" type="text/css">
<link href="<?= base_url() ?>assets/vendor/usertemp/styles/framework.css"       rel="stylesheet" type="text/css">
<link href="<?= base_url() ?>assets/vendor/usertemp/styles/font-awesome.css"    rel="stylesheet" type="text/css">
<link href="<?= base_url() ?>assets/vendor/usertemp/styles/animate.css"         rel="stylesheet" type="text/css">

<script type="text/javascript" src="<?= base_url() ?>assets/vendor/usertemp/scripts/jquery.js"></script>
<script type="text/javascript" src="<?= base_url() ?>assets/vendor/usertemp/scripts/jqueryui.js"></script>
<script type="text/javascript" src="<?= base_url() ?>assets/vendor/usertemp/scripts/framework-plugins.js"></script>
<script type="text/javascript" src="<?= base_url() ?>assets/vendor/usertemp/scripts/custom.js"></script>
</head>
...
<div id="preloader">
	<div id="status">
        ...
        <h3 class="center-text">Selamat</h3>
        <p class="center-text smaller-text">
           tak perlu bingung memasak lagi
        </p>
    </div>
</div>
...
<div id="header-fixed" >
    ...
    <a class="header-logo-text" href="index.html">DapurPintar</a>
        ...
        <div class="snap-drawer snap-drawer-left">    
            <div class="sidebar-header">
                <div class="sidebar-header-logo">
                    <h2 class="al-center">DapurPintar</h2>
                </div>
            ...
            <div class="sidebar-menu half-bottom">
                ...
                <!-- <div class="has-submenu">
                    ...
                    <div class="submenu submenu-active">
                        <a class="submenu-item submenu-item-active" href="index.html">      <i class="fa fa-angle-right"></i><em>   Classic Slider    </em><i class="fa fa-circle"></i></a>
                        <a class="submenu-item" href="index2.html">     <i class="fa fa-angle-right"></i><em>   Material Slider     </em><i class="fa fa-circle"></i></a>
                        <a class="submenu-item" href="index3.html">     <i class="fa fa-angle-right"></i><em>   Circle Slider     </em><i class="fa fa-circle"></i></a>
                        <a class="submenu-item" href="index4.html">     <i class="fa fa-angle-right"></i><em>   Fullscreen Slider    </em><i class="fa fa-circle"></i></a>
                        <a class="submenu-item" href="index5.html">     <i class="fa fa-angle-right"></i><em>   Simple Image    </em><i class="fa fa-circle"></i></a>
                        <a class="submenu-item" href="index6.html">     <i class="fa fa-angle-right"></i><em>   Landing  Thumbs    </em><i class="fa fa-circle"></i></a>
                    </div>
                </div>  --> 
                ...
                <!-- <div class="has-submenu">
                    ...
                    <div class="submenu">
                        ...
                        <a class="submenu-item" href="index-thumbs.html">     <i class="fa fa-angle-right"></i><em>   Thumbnails Menu    </em><i class="fa fa-circle"></i></a>
                        <a class="submenu-item" href="index-material.html">     <i class="fa fa-angle-right"></i><em>   Material Menu    </em><i class="fa fa-circle"></i></a>
                    </div>
                </div>    -->           
               <!--  <div class="has-submenu">
                    <a class="menu-item show-submenu" href="#">
                ...
                <div class="has-submenu">
                    ...
                    <div class="submenu">
                        <a class="submenu-item" href="<?= base_url() ?>Login">      <i class="fa fa-angle-right"></i><em>Login</em><i class="fa fa-circle"></i></a>
                        <a class="submenu-item" href="<?= base_url() ?>Register">      <i class="fa fa-angle-right"></i><em>Register</em><i class="fa fa-circle"></i></a>
                ...
                <!-- <div class="has-submenu">
                    ...
                    <div class="submenu">
                        ...
                        <a class="submenu-item" href="pageapp-login.html"><i class="fa fa-angle-right"></i><em>   Login Screen       </em><i class="fa fa-circle"></i></a>
