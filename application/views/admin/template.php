...
<head>
  ...
  <!-- Favicon -->
  <link rel="shortcut icon" href="<?= base_url() ?>assets/vendor/usertemp/images/pin.png" type="image/x-icon">
    ...
    <nav id="nav" class="navbar navbar-inverse navbar-fixed-top" role="navigation">
      ...
      <div class="collapse navbar-collapse navbar-ex1-collapse">
        <ul class="nav navbar-nav side-nav">
          ...
          <li>
            <a href="<?= base_url().'admin/Resep' ?>"><i class="fa fa-fw fa-file"></i> Resep</a>
          </li>
          

          <?php if($this->session->userdata('logged_in')['admin']) { ?>
            <li>
              <a href="<?= base_url().'admin/Admin' ?>"><i class="fa fa-fw fa-user"></i> Admin </a>
            </li>
            <li>
